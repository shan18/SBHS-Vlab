...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Experiment.user'
        db.add_column(u'tables_experiment', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tables.Account']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Experiment.user'
        db.delete_column(u'tables_experiment', 'user_id')
